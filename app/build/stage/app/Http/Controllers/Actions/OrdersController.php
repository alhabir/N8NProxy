...
class OrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $endpoint = Endpoint::expand(Endpoint::orders()['list'], $request->all());
    ...
    {
        $merchantId = $request->input('merchant_id');
        $endpoint = Endpoint::expand(Endpoint::orders()['get'], ['id' => $id]);
    ...
    {
        $merchantId = $request->input('merchant_id');
        $endpoint = Endpoint::expand(Endpoint::orders()['create']);
    ...
    {
        $merchantId = $request->input('merchant_id');
        $endpoint = Endpoint::expand(Endpoint::orders()['update'], ['id' => $id]);
    ...
    {
        $merchantId = $request->input('merchant_id');
        $endpoint = Endpoint::expand(Endpoint::orders()['delete'], ['id' => $id]);
